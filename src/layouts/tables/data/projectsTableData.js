...
export default function data() {
  return {
    ...
    rows: [
      ...
      {
        subject: <Subject name="Java" />,
        category: <Category category="Programming" />,
        difficultyLevel: <DifficultyLevel level="Hard" />,
        status: <StatusBadge status="Active" />,
        courseLink: <RedirectToCourse courseName="Java" />,
      },
      {
        subject: <Subject name="Operating Systems" />,
        category: <Category category="Networking" />,
        difficultyLevel: <DifficultyLevel level="Hard" />,
        status: <StatusBadge status="Completed" />,
        courseLink: <RedirectToCourse courseName="Operating Systems" />,
      },
      {
        subject: <Subject name="Aptitude" />,
        category: <Category category="Logical Thinking" />,
        difficultyLevel: <DifficultyLevel level="Medium" />,
        status: <StatusBadge status="Inactive" />,
        courseLink: <RedirectToCourse courseName="Aptitude" />,
      },
    ],
  };
}
